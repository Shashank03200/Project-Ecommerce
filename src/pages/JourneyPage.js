...
const JourneyPage = () => {
  return (
    <div className="JourneyPage">
      <div className="JourneyPage__Header">
        <h2>THE JOURNEY</h2>
      </div>
      <div className="JourneyPage__Content">
        <div className="JourneyPage__Content__Item">
          <h3>THE ROOTS</h3>
          <p>
        ...
        <div className="JourneyPage__Content__Item">
          ...
          <p>
            ...
            user's shoes and look at what we plan to do. Its a great joy for the
            users if they are involved in the making. Were heading into an era
            of technology and people prefer online shopping to shopping in an
            outlet.
          </p>
        </div>
        <div className="JourneyPage__Content__Item">
